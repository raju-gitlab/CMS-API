...
namespace CMS.BUSINESS.Business.Master.AdminPortal
{
    public class AdminPortalBusiness : IAdminPortalBusiness
    {
        ...
        {
            return this._adminPortalRepository.IsUserTeacherOrAdmin(userId);
        }
        #endregion
        ...
        public string ForgetPassword(string UserEmail)
        {
            try
            {
                if (this._adminPortalRepository.IsUserTeacherOrAdmin(UserEmail))
                {
                    return this._adminPortalRepository.ForgetPassword(UserEmail);
                }
                else
                {
                    return Convert.ToString("UserUnauthenticated");
                }
            }
            catch (Exception ex)
            {
        ...
        {
            return this._adminPortalRepository.Verify(itemCode);
        }
        #endregion
        ...
        {
            return this._adminPortalRepository.CreateMeeting(meeting);
        }
        #endregion
        ...
        {
            return this._adminPortalRepository.UpdatePassword(data);
        }
        #endregion
        #endregion
