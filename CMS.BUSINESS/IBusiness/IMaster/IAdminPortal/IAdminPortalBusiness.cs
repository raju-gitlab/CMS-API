...
namespace CMS.BUSINESS.IBusiness.IMaster.IAdminPortal
{
    public interface IAdminPortalBusiness
    {
        ...
        #region Checks
        bool IsUserTeacherOrAdmin(string UserId);
        #endregion
        ...
        string ForgetPassword(string UserEmail);
        #endregion

        #region CheckVerificationCode
        bool Verify(ItemCode itemCode);
        #endregion

        #region Create Meeting
        bool CreateMeeting(MeetingModel meeting);
        #endregion
        #endregion
        ...
        bool UpdatePassword(ItemCode data);
        #endregion
        #endregion
